...
impl Sprite {
    ...
    fn set_size(&mut self, width: f32, height: f32) {
        self.size_matrix = Mat4::identity().scale(&[width, height, 1.]);
        self.update_matrix();
    }
    ...
    fn set_position(&mut self, x: f32, y: f32, z: f32) {
        self.position_matrix = Mat4::identity()::translate(&[x, y, z]);
        self.update_matrix();
    }
    ...
    fn render(&self, gl: WebGlRenderingContext, c: &render::Camera, plane_vao: i32, texture_program: WebGlProgram) {
        ...
        let texture_uniform = texture_program.locations.texture_location();
